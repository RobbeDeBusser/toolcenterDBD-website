  ...
  build: {
    rollupOptions: {
      input: {
        ...
        gereedschapskisten: resolve(__dirname, "gereedschapskisten.html"),
        gereedschapssets: resolve(__dirname, "gereedschapssets.html"),
        wallmek: resolve(__dirname, "wallmek.html"),
      },
    },
  },
});
